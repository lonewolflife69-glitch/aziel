/**
 * ===================================================================
 * AZIEL & RYAN - GIRLFRIEND DAY WEBSITE CONFIGURATION
 * ===================================================================
...
window.AZIEL_CONFIG = {
  // Names & Signatures
  girlfriendName: "Aziel",
  boyfriendName: "Ryan",
  boyfriendSignature: "Ryan (ur champak)",
  ...
  frameRevealText: {
    line1: "For the girl who loves lilies...",
    line2: "...and somehow became my favorite thing too.",
    line3: "Aziel, if I could give you one thing today, it would be the ability to see yourself through my eyes."
  },

  heroText: {
    title: "Happy Girlfriend Day, Aziel ♡",
  ...
  romanticQuotes: [
    ...
    "I hope you know how beautiful you are, especially in the moments when you don't realize it.",
  ...
  photoAppreciations: [
    {
      photo: "assets/images/aziel_1.jpg",
      quote: "Can we just take a second to appreciate you? Yeah... you're really beautiful."
    },
    {
      photo: "assets/images/aziel_2.jpg",
  ...
  justUsConfig: {
    ...
    memories: [
      ...
      },
      {
        ...
        photo: "assets/images/aziel_story4.jpg",
      ...
      },
      {
        ...
        photo: "assets/images/aziel_polaroid1.jpg",
      ...
      },
      {
        ...
        photo: "assets/images/aziel_polaroid2.jpg",
        caption: "Us being completely us."
      },
      {
        type: "interactive-card",
        cardTitle: "Tap to reveal a silly moment 😜",
        photo: "assets/images/aziel_polaroid3.jpg",
        caption: "This one will always make me laugh!",
        badge: "Silly Moments"
      },
      {
        type: "photo-first",
        photo: "assets/images/aziel_polaroid4.jpg",
  ...
  polaroids: [
    ...
    {
      photo: "assets/images/aziel_polaroid5.jpg",
      caption: "how are you even real?",
      rotation: -4
    },
    {
      photo: "assets/images/aziel_polaroid6.jpg",
  ...
  reasons: [
    ...
    "I love your kindness, your gentle heart, and the warmth you give to everyone around you.",
  ...
  quiz: [
    {
      question: "What is Aziel's absolute favorite flower in the world?",
      options: ["Roses", "Lilies", "Sunflowers", "Tulips"],
      correctIndex: 1,
      correctMsg: "Correct! Lilies are your favorite, and you are mine! 🌸✨",
      wrongMsg: "Hmm... try again! Hint: Look around the screen! 🌿"
    },
    {
      question: "Who is the most lucky boyfriend on planet Earth?",
      options: ["Ryan (ur champak)", "Ryan", "Definitely Ryan", "All of the above"],
      correctIndex: 3,
      correctMsg: "100% true! I am the luckiest guy alive to have you! ❤️",
    ...
    },
    {
      ...
      options: ["Winning the lottery", "Eating pizza", "Spending it with Aziel", "A rainy afternoon"],
      correctIndex: 2,
  ...
  loveLetter: {
    ...
    bodyParagraphs: [
      ...
      "From the moment you came into my life, everything became warmer, brighter, and softer. You have this rare, quiet magic about you — the way you smile, the way you care so deeply, and the effortless way you make everywhere feel like home.",
      "I love all the little things: our inside jokes, the quiet moments when we don't even need to speak, the shared glances, and the sound of your laugh. You've taught me what true gentleness and companionship feel like.",
      "Thank you for being my favorite person, my safe space, my best friend, and my girlfriend. I wouldn't trade a single second we've shared for anything in the world.",
  ...
  finale: {
    ...
    finalPhoto: "assets/images/aziel_final.jpg",
    dayGreeting: "Happy Girlfriend Day, Aziel.",
